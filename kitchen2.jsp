...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="kitchen2.jpg" width="990" height="500" /></p>
    <h2 align="center">&nbsp;<em>Ticky Kitchen Rack</em></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="kitchen2.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        ...
        <p><strong>Warranty:</strong>&nbsp;22 years' Warranty</p>
        <p><strong>Units</strong>-Shelf Cabinet,open Cabinets, Wall Cabinets.     </p>
        <p><strong>Cost: </strong>45,765 </p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Ticky Kitchen Rack";
 String pr="45,765";
 String wr="22 years Warranty";
 String bd="Spacewood";
