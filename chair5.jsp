...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair5.jpg" width="419" height="239" /></p>
    <h2 align="center"><strong>Yuten Longe Chair</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center"><strong>Details</strong></h2>
    <form id="form1" name="form1" method="post" action="chair5.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong> <span itemprop="brand">Amberville</span></p>
        <p><strong>Dimensions:</strong> H 29 x W 24 x D 20; Seating Height - 18</p>
        <p><strong>Colour:</strong> Honey Oak</p>
        ...
        <p><strong>Height:</strong> 29.0 inches</p>
        <p><strong>Width:</strong> 24.0 inches</p>
        <p><strong>Depth:</strong> 20.0 inches</p>
        <p><strong>Seating Height:</strong> 18</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1476214-S-PM7262</span></p>
        <p><strong>Cost : 7,888 </strong></p>
        <p>&nbsp;</p>
        <p>
          <label>
