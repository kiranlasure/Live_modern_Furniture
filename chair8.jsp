...
<table width="1335" border="1">
  <tr>
    <td width="1296" height="81"><a href="main.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image2','','h2.jpg',1)"><img src="h1.jpg" name="Image2" width="20%" border="0" id="Image2" /></a><a href="admlogin.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','adm.jpg',1)"><img src="adm1.jpg" name="Image3" width="20%" border="0" id="Image3" /></a><a href="custlogin.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','cust2.jpg',1)"><img src="cust1.jpg" name="Image4" width="20%" border="0" id="Image4" /></a><a href="aboutus.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','ab2.jpg',1)"><img src="ab1.jpg" name="Image5" width="20%" border="0" id="Image5" /></a><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image10','','contact1.jpg',1)"><img src="contact1 (3).jpg" name="Image10" width="20%" border="0" id="Image10" /></a><a href="main.jsp" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','lo.jpg',1)"></a></td>
  </tr>
</table>
<table width="1335" height="934" border="1">
  <tr>
    <td width="316" height="928" valign="top"><p>&nbsp;</p>
      <h3 align="center"><a href="chairs.jsp">Go Back To Chair Selection </a></h3></td>
    <td width="1003" valign="top"><p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="center"><img src="chair8.jpg" width="437" height="247" /></p>
    <h2 align="center"><strong>Dining Table Chairs</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="chair8.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong> <span itemprop="brand">Woodsworth</span></p>
        <p><strong>Dimensions:</strong> Table : H 30 x W 57 x D 33 ;Chair : H 42 x W 18 x D 18 ; Seating Height : 18 Inch</p>
        <p><strong>Weight:</strong> 88 KG</p>
        <p><strong>Colour:</strong> Provincial Teak</p>
        <p><strong>Warranty:</strong> 12 Months' Warranty</p>
        <p><strong>Assembly:</strong> Carpenter Assembly</p>
        <p><strong>Primary Material:</strong> Sheesham Wood</p>
        <p><strong>Room Type:</strong> Dining Room</p>
        <p><strong>Collection:</strong> Woodway</p>
        <p><strong>Height:</strong> 30.0 inches</p>
        <p><strong>Width:</strong> 57.0 inches</p>
        <p><strong>Depth:</strong> 33.0 inches</p>
        <p><strong>Seating Capacity:</strong> 4 Seater</p>
        <p><strong>Seating Height:</strong> 18</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1523381-P-WH8952</span></p>
        <p><strong>Cost: </strong>22,222 </p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Dining Table Chairs";
 String pr="22,222";
 String wr="12 Months Warranty";
 String bd="Woodsworth";
String query="insert into cart values('"+nm+"','"+pr+"','"+wr+"','"+bd+"')";
...
if(k!=0)
{
     %>
	  ...
	  alert("product Will Added to cart");
	  window.open("cash.jsp","_self"); 
	  </script>
