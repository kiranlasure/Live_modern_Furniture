...
<table width="1335" height="934" border="1">
  <tr>
    <td width="316" height="928" valign="top"><p>&nbsp;</p>
      <h3 align="center"><a href="kitchen.jsp">Go Back To Kitchen Selection </a></h3></td>
    <td width="1003" valign="top"><p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="center"><img src="kitchen1.jpg" width="990" height="500" /></p>
    <h2 align="center">&nbsp;<strong>&nbsp;<em><strong>Jeeves Kitchen Rack</strong></em></strong></h2>
    <h3 align="center">&nbsp;</h3>
    <h2 align="center"><strong>Details</strong></h2>
    <form id="form1" name="form1" method="post" action="kitchen1.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Spacewood</span></p>
        <p><strong>Price Include</strong>:Shutter finish, acycric</p>
        <p><strong>Warranty:</strong>&nbsp;18 years' Warranty</p>
        <p><strong>Material: </strong>PLPB in dry areas and WBR in wet </p>
        <p>area of kitchten </p>
        <p><strong>Units</strong> : shelf Cabinents, Drawers with SS baskets,</p>
        <p>mid heightUnits, Lift Ups  </p>
        <p><strong>Cost</strong>: 65,788 </p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Jeeves Kitchen Rack";
 String pr="65,788";
 String wr="18 years Warranty";
 String bd="Spacewood";
