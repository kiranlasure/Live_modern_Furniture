...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="Bed1.jpg" width="422" height="265" /></p>
    <h2 align="center"><strong>B</strong>eds With Storage</h2>
    <h3 align="center">&nbsp;</h3>
    <h3 align="center">Details</h3>
    <form id="form1" name="form1" method="post" action="">
      <label></label>
      <div align="center">
        <h3><strong>Brand:</strong>&nbsp;<span itemprop="brand">Mintwud</span></h3>
        <p><strong>Dimensions:</strong>&nbsp;H 40 x W 66.7 x D 77.6; Mattress Size : 60 x 75(Not Included); Seating Height - 14</p>
        <p><strong>Weight:</strong>&nbsp;102 KG</p>
        ...
        <p><strong>Height:</strong>&nbsp;40.0 inches</p>
        <p><strong>Width:</strong>&nbsp;67.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;78.0 inches</p>
        <p><strong>Seating Height:</strong>&nbsp;14</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1567946-P-WH18414</span></p>
        <p>Cost: 40,555 </p>
        <p>
          <label></label>
        </p>
    ...
    <p align="center">&nbsp;</p>
    <form id="form2" name="form2" method="post" action="Bed1.jsp">
      <label>
