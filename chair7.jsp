...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair7.jpg" width="430" height="254" /></p>
    <h2 align="center"><strong>Two Longe Chairs</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="chair7.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        <p><strong>Brand:</strong> <span itemprop="brand">Amberville</span></p>
        <p><strong>Dimensions:</strong> H 35 x W 30 x D 28; Seating Height - 18</p>
        <p><strong>Weight:</strong> 21 KG</p>
        <p><strong>Colour:</strong> Rosewood</p>
        <p><strong>Warranty:</strong> 12 Months' Warranty</p>
        <p><strong>Assembly:</strong> No Assembly Required</p>
        <p><strong>Primary Material:</strong> Solid Wood</p>
        <p><strong>Room Type:</strong> Living Room</p>
        <p><strong>Collection:</strong> Lorraine</p>
        <p><strong>Height:</strong> 35.0 inches</p>
        <p><strong>Width:</strong> 30.0 inches</p>
        <p><strong>Depth:</strong> 28.0 inches</p>
        <p><strong>Seating Height:</strong> 18</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1469288-P-WH17849</span></p>
        <p><strong>Cost: </strong>6,876 </p>
        <p>&nbsp;</p>
        <p>
          <label>
