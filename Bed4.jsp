...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="Bed4.jpg" width="442" height="276" /></p>
    <h2 align="center">&nbsp;&nbsp;<strong>Single Bed</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="Bed4.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Alsapan</span></p>
        <p><strong>Dimensions:</strong>&nbsp;34.64 H x 39.37 W x 76.37 D; Seating height: 16.1 H</p>
        <p><strong>Warranty: </strong>18 months' warranty </p>
        <p><strong>Assembly:</strong>&nbsp;Carpenter Assembly</p>
        <p><strong>Primary Material:</strong>&nbsp;Particle Board</p>
        <p><strong>Room Type:</strong>&nbsp;Bedroom</p>
        <p><strong>Height:</strong>&nbsp;34.64 inches</p>
        <p><strong>Width:</strong>&nbsp;39.37 inches</p>
        <p><strong>Depth:</strong>&nbsp;76.37 inches</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1579491-P-WH21249</span></p>
        <p><strong>Cost</strong>: 33,999</p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Single Bed";
 String pr="33,999";
 String wr="18 Months Warranty";
 String bd="Alsapan";
