...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair1.jpg" width="435" height="317" /></p>
    <h2 align="center"><strong>Winchestor Longe Chair</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center"><strong>Details</strong></h2>
    <form id="form1" name="form1" method="post" action="chair1.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">CasaCraft</span></p>
        <p><strong>Dimensions:</strong>&nbsp;H 41.3 x W 26.3 x D 30.3; Seating Height - 14.2</p>
        <p><strong>Weight:</strong>&nbsp;33 KG</p>
        <p><strong>Warranty:</strong>&nbsp;12 Months' Warranty</p>
        <p><strong>Assembly:</strong>&nbsp;Carpenter Assembly</p>
        <p><strong>Primary Material:</strong>&nbsp;Fabric</p>
        <p><strong>Room Type:</strong>&nbsp;Living Room</p>
        <p><strong>Height:</strong>&nbsp;41.3 inches</p>
        <p><strong>Width:</strong>&nbsp;26.3 inches</p>
        <p><strong>Depth:</strong>&nbsp;30.3 inches</p>
        <p><strong>Seating Height:</strong>&nbsp;14.2</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1512616-P-WH1210</span></p>
        <p><strong>Cost: </strong>3,999 </p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Winchestor Longe Chair";
 String pr="3,999";
