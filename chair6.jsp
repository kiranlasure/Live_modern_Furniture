...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair6.jpg" width="390" height="264" /></p>
    <h2 align="center"><strong>&nbsp;Hagen Longe Chair</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center"><strong>Details</strong></h2>
    <form id="form1" name="form1" method="post" action="chair6.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        <p><strong>Brand:</strong> <span itemprop="brand">Bohemiana</span></p>
        <p><strong>Dimensions:</strong> H 32 x W 19 x D 20; Seating Height - 16</p>
        ...
        <p><strong>Height:</strong> 32.0 inches</p>
        <p><strong>Width:</strong> 19.0 inches</p>
        <p><strong>Depth:</strong> 20.0 inches</p>
        <p><strong>Seating Height:</strong> 16</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1550383-S-PM19616</span></p>
        <p><strong>Cost :54,667 </strong></p>
        <p>&nbsp;</p>
        <p>
          <label>
