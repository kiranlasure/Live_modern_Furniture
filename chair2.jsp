...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair2.jpg" width="439" height="249" /></p>
    <h2 align="center"><strong> Coco Longe Chair</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="chair2.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Afydecor</span></p>
        <p><strong>Dimensions:</strong>&nbsp;H 43 x W 34 x D 30; Seating Height - 16.5</p>
        ...
        <p><strong>Height:</strong>&nbsp;43.0 inches</p>
        <p><strong>Width:</strong>&nbsp;38.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;37.0 inches</p>
        <p><strong>Seating Height:</strong>&nbsp;17</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1348055-S-PM20529</span></p>
        <p><strong>Cost</strong> : 11,999 </p>
        <p>&nbsp;</p>
        <p>
          <label>
