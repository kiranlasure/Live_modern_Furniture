...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="Bed2.jpg" width="416" height="253" /></p>
    <h2 align="center"><strong>Double Bed</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <p align="center">&nbsp;</p>
        <form id="form1" name="form1" method="post" action="Bed2.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Mintwud</span></p>
        <p><strong>Dimensions:</strong>&nbsp;H 36 x W 62.8 x D 82.8; Mattress Size : 60 x 78(Not Included)</p>
        <p><strong>Warranty:</strong>&nbsp;12 Months' Warranty</p>
        <p><strong>Assembly:</strong>&nbsp;Carpenter Assembly</p>
        <p><strong>Primary Material:</strong>&nbsp;Metal</p>
        <p><strong>Room Type:</strong>&nbsp;Bedroom</p>
        <p><strong>Height:</strong>&nbsp;36.0 inches</p>
        <p><strong>Width:</strong>&nbsp;63.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;83.0 inches</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1473370-P-WH5046</span></p>
        <p>Cost: 67,999<label></label>
        </p>
        <p>
          <label>
