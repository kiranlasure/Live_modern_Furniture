...
PreparedStatement stm=con.prepareStatement("select uid,cpass from signup2 where uid=? and cpass=?");
stm.setString(1,uid);
stm.setString(2,cpass);
...
String password=rs.getString(2);
       if(uid.equals(username) && cpass.equals(password))
	   {
	  %>
