...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="Bed6.jpg" width="428" height="271" /></p>
    <h2 align="center"><strong>Spetial Bed</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="Bed6.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Mintwud</span></p>
        <p><strong>Dimensions:</strong>&nbsp;Bed : H 36 x W 63 x D 82; Mattress Size : 60 x 78(Not Included)</p>
        <p><strong>Warranty:</strong>&nbsp;9 Months' Warranty</p>
        ...
        <p><strong>Width:</strong>&nbsp;63.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;82.0 inches</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1359860-Z-WH5046</span></p>
        <p><strong>Cost</strong>: 78,999 </p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Spetil Bed";
 String pr="78,999";
 String wr="9 Months Warranty";
 String bd="Mintwud";
