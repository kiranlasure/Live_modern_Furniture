...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair9.jpg" width="403" height="257" /></p>
    <h2 align="center"><strong>Single Chair</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="chair9.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        <p><strong>Brand:</strong> <span itemprop="brand">Amberville</span></p>
        <p><strong>Dimensions:</strong> H 46 x W 17 x D 18; Seating Height - 30 </p>
        <p><strong>Weight:</strong> 20 KG</p>
        <p><strong>Colour:</strong> Warm Chestnut</p>
        ...
        <p><strong>Room Type:</strong> Bar</p>
        <p><strong>Height:</strong> 46.0 inches</p>
        <p><strong>Width:</strong> 17.0 inches</p>
        <p><strong>Depth:</strong> 18.0 inches</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1581633-P-WH6418</span></p>
        <p><strong>Cost</strong> : 5,555 </p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Single Chair";
 String pr="5,555";
 String wr="12 Months Warranty";
 String bd="Amberville";
