...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="Bed5.jpg" width="437" height="245" /></p>
    <h2 align="center"><strong>&nbsp;Double Bed</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="Bed5.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Spacewood</span></p>
        <p><strong>Dimensions:</strong>&nbsp;Bed : H 36.4 x W 63.8 x D 82.3; Mattress Size : 60 x 78 (Not Included); Seating Height-14; Bedside Table : H 15.7 x W 15.7 x D 12</p>
        <p><strong>Warranty:</strong>&nbsp;36 Months' Warranty</p>
        ...
        <p><strong>Height:</strong>&nbsp;36.0 inches</p>
        <p><strong>Width:</strong>&nbsp;64.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;82.0 inches</p>
        <p><strong>Seating Height:</strong>&nbsp;14</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1533808-P-WH4374</span></p>
        <p><strong>Cost</strong>: 56,999 </p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Double Bed";
 String pr="56,999";
 String wr="36 Months Warranty";
 String bd="Spacewood";
