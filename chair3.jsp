...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair3.jpg" width="456" height="279" /></p>
    <h2 align="center"><strong>Bobin Longe Chair</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="chair3.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Amberville</span></p>
        <p><strong>Dimensions:</strong>&nbsp;H 37 x W 26 x D 30; Seating Height - 16</p>
        ...
        <p><strong>Height:</strong>&nbsp;37.0 inches</p>
        <p><strong>Width:</strong>&nbsp;26.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;30.0 inches</p>
        <p><strong>Seating Height:</strong>&nbsp;16</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1447898-P-WH10273</span></p>
        <p><strong>Cost</strong> : 13,876 </p>
        <p>&nbsp;</p>
        <p>
          <label>
