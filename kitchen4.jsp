...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="kitchen4.jpg" width="990" height="500" /></p>
    <h2 align="center"><em>Chinies Kitchen Rack</em></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="kitchen4.jsp">
      <label></label>
      <div align="center">
        <p>19 Feet* 10 Feet</p>
        ...
        <p>Units-Shelf Cabinet,open Cabinets. </p>
...
Statement statement = con.createStatement();
 String nm="Chinies Kitchen Rack";
 String pr="65,788";
