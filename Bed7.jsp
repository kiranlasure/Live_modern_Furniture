...
<table width="1335" height="934" border="1">
  <tr>
    <td width="316" height="928" valign="top"><p>&nbsp;</p>
      <h3 align="center"><a href="Beds.jsp">Go Back To Beds Selection </a></h3></td>
    <td width="1003" valign="top"><p>&nbsp;</p>
    <p>&nbsp;</p>
    <p align="center"><img src="Bed7.jpg" width="414" height="255" /></p>
    <h2 align="center">&nbsp;&nbsp;<strong>&nbsp;Small Bed</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center"><strong>Details</strong></h2>
    <form id="form1" name="form1" method="post" action="Bed7.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Crystal Furnitech</span></p>
        <p><strong>Dimensions:</strong>&nbsp;Bed : H 42 x W 84 x D 81; Mattress Size : 72 x 78(Not Included); Seating Height - 15</p>
        <p><strong>Weight:</strong>&nbsp;180 KG</p>
        <p><strong>Warranty:</strong>&nbsp;6 Months' Warranty</p>
        <p><strong>Assembly:</strong>&nbsp;Carpenter Assembly</p>
        <p><strong>Primary Material:</strong>&nbsp;Engineered Wood</p>
        <p><strong>Room Type:</strong>&nbsp;Bedroom</p>
        <p><strong>Height:</strong>&nbsp;42.0 inches</p>
        <p><strong>Width:</strong>&nbsp;84.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;81.0 inches</p>
        <p><strong>Seating Height:</strong>&nbsp;15</p>
        <p><strong>Sku:</strong><span itemprop="sku">FN1492482-P-WH11422</span></p>
        <p><strong>Cost</strong>:33,333</p>
        <p>&nbsp;</p>
        <p>
          <label>
...
Statement statement = con.createStatement();
 String nm="Small Bed";
 String pr="33,333";
 String wr="6 Months Warranty";
 String bd="Crystal Furnitech";
