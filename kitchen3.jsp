...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="kitchen3.jpg" width="990" height="500" /></p>
    <h2 align="center">&nbsp;<em>Spetial Kitchen Rack</em></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center"><strong>Details</strong></h2>
    <form id="form1" name="form1" method="post" action="kitchen3.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        ...
        <p><strong>Price Includes:</strong>Material- PLPB in Dry areas</p>
        <p>and BWR ply in wet area of kitchen</p>
        <p><strong>Warranty:</strong>&nbsp;18 years' Warranty</p>
        <p><strong>Units</strong>-Shelf Cabinet,open Cabinets, Wall Cabinets. </p>
        <p><strong>Cost</strong>: 65,888</p>
        <p>&nbsp;</p>
        <p>
          <label>
