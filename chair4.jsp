...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="chair4.jpg" width="452" height="272" /></p>
    <h2 align="center"><strong>Spetial Chair</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="chair4.jsp">
      <strong>
      <label></label>
      </strong>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Bohemiana</span></p>
        <p><strong>Dimensions:</strong>&nbsp;H 31 x W 16 x D 16</p>
        ...
        <p><strong>Height:</strong>&nbsp;31.0 inches</p>
        <p><strong>Width:</strong>&nbsp;16.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;16.0 inches</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1503004-P-WH14875</span></p>
        <p><strong>Cost : </strong>15,888</p>
        <p>&nbsp;</p>
        <p>
          <label>
