...
<table width="1335" height="934" border="1">
  <tr>
    ...
    <p>&nbsp;</p>
    <p align="center"><img src="Bed8.jpg" width="416" height="248" /></p>
    <h2 align="center">&nbsp;&nbsp;&nbsp;<strong>&nbsp;Big Bed</strong></h2>
    <h2 align="center">&nbsp;</h2>
    <h2 align="center">Details</h2>
    <form id="form1" name="form1" method="post" action="Bed8.jsp">
      <label></label>
      <div align="center">
        <p><strong>Brand:</strong>&nbsp;<span itemprop="brand">Woodsworth</span></p>
        <p><strong>Dimensions:</strong>&nbsp;Bed : H 36 x W 75 x D 81; Mattress Size : 72 x 78(Not Included); Seating Height - 16</p>
        ...
        <p><strong>Collection:</strong>&nbsp;Maritsa</p>
        <p><strong>Height:</strong>&nbsp;36.0 inches</p>
        <p><strong>Width:</strong>&nbsp;75.0 inches</p>
        <p><strong>Depth:</strong>&nbsp;81.0 inches</p>
        <p><strong>Seating Height:</strong>&nbsp;16</p>
        <p><strong>Sku:</strong><span itemprop="sku">FM1260942-P-WH6418</span></p>
        <p><strong>Cost</strong>: 55,999</p>
        <p>&nbsp;</p>
        <p>
          <label>
